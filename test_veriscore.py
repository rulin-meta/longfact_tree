...
DEFAULT_VERISCORE_URL = "http://10.137.193.1:56729/veriscore"
...
def test_veriscore(question: str, response: str, last_sentence_only: bool = True) -> Dict[str, Any]:
    """
...
if __name__ == "__main__":
    ...
    result1 = test_veriscore(question1, response1)
    ...
    result2 = test_veriscore(question2, response2)
    ...
    result3 = test_veriscore(question3, response3)
    ...
    result3_full = test_veriscore(question3, response3, last_sentence_only=False)
